...
func TestParseName(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "mixed case", value: "Agent-001"},
		{name: "dot and underscore", value: "agent.pool_1"},
		{name: "trailing separator", value: "agent-"},
		{name: "single character", value: "a"},
		{name: "zero", value: "", wantErr: true},
		{name: "leading hyphen", value: "-agent", wantErr: true},
		{name: "leading dot", value: ".agent", wantErr: true},
		{name: "slash", value: "agent/1", wantErr: true},
		{name: "space", value: "agent 1", wantErr: true},
		{name: "non ASCII", value: "智能体", wantErr: true},
