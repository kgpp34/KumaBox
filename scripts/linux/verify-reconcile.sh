...
usage() {
  cat <<'USAGE'
Usage:
  scripts/linux/verify-reconcile.sh --root-disk PATH --firmware PATH [options]
  scripts/linux/verify-reconcile.sh --root-disk PATH --kernel PATH --initrd PATH [options]
