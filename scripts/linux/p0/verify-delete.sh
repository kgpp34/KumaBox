...
usage() {
  cat <<'USAGE'
Usage:
  scripts/linux/p0/verify-delete.sh --root-disk PATH --firmware PATH [options]
  scripts/linux/p0/verify-delete.sh --root-disk PATH --kernel PATH --initrd PATH [options]
