#!/usr/bin/env bash
# scripts/kumabox-check.sh — Pre-flight check and repair tool for KumaBox.
#
# Usage:
#   ./scripts/kumabox-check.sh              # Check only
#   ./scripts/kumabox-check.sh --fix        # Check and fix issues
#   ./scripts/kumabox-check.sh --upgrade    # Check, fix, and upgrade dependencies
...
check_dir "${KUMABOX_RUN_DIR}/locks/images"
